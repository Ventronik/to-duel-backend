...
exports.seed = function(knex, Promise) {
  ...
  { id: 1, name: 'Soup - Campbells Beef Noodle',
  ...
  { id: 3, name: 'Chickhen - Chicken Phyllo',
  ...
  { id: 5, name: 'Wine - White, Riesling, Semi - Dry',
  ...
  { id: 6, name: 'Cheese - Taleggio D.o.p.',
  ...
  { id: 8, name: 'Tea - Darjeeling, Azzura',
  ...
  { id: 12, name: 'Jam - Strawberry, 20 Ml Jar',
  ...
  { id: 14, name: 'Remy Red Berry Infusion',
  ...
  { id: 15, name: 'Wine - Chateau Bonnet',
  ...
  { id: 18, name: 'Extract Vanilla Pure',
  ...
  { id: 21, name: 'Wine - Red, Gamay Noir',
  ...
  { id: 23, name: 'Mushroom - Shitake, Dry',
  ...
  { id: 26, name: 'Olives - Black, Pitted',
  ...
  { id: 27, name: 'Cocoa Powder - Natural',
  ...
  { id: 28, name: 'Mushroom - Oyster, Fresh',
  ...
  { id: 29, name: 'Rosemary - Primerba, Paste',
